  ...
  template: `
    <mat-horizontal-stepper [linear]="isLinear" #stepper (animationDone)="animationDone()">
      ...
      <ng-template matStepperIcon="edit">
        <mat-icon style="padding: 4px;" [ngStyle]="{'background-color': firstFormGroup.controls['customerLabel']?'green': 'undefined'}">check</mat-icon>
      </ng-template>
        ...
        <form [formGroup]="firstFormGroup">
          ...
          <div>
            <!--<mat-form-field style="width: 300px">-->
              <!--<input id="customerLabel" matInput name="customerLabel" placeholder="Customer" formControlName="customerLabel" required readonly>-->

            <!--</mat-form-field>-->

            <system-lookup [isModal]="true" lookupName="customers" [data]="customersLookupData" (onSelected)="onSelectCustomer($event)"></system-lookup>
          </div>
        </form>
      </mat-step>
      <mat-step [stepControl]="secondFormGroup" [completed]="!isLinear || secondFormGroup.valid">
        ...
        <form [formGroup]="secondFormGroup" autocomplete="off">
          <div>
            <mat-tab-group [(selectedIndex)]="selectedBranchTabIndex">
              <mat-tab label="Branches">
                <div style="padding: 10px;">
                  <system-lookup [isModal]="true" (onComplete)="onBranchComplete($event)" #customerMeetingsBranches lookupName="customerMeetingsBranches" (emitDataChange)="emitBranchEvent($event)" [documentId]="customerId" (onSelected)="onSelectBranch($event)"></system-lookup>
                </div>
              </mat-tab>
              <mat-tab label="Add New Branch">
                <div>
              ...
              <mat-tab label="Edit Branch" *ngIf="hasEditBranchTab">
                <div style="padding: 10px;">
                  ...
                  <div>
                    <button mat-button mat-raised-button (click)="updatePendingBranch()" color="primary">Update</button>
                  </div>
      ...
      <mat-step [stepControl]="thirdFormGroup" [completed]="!isLinear || thirdFormGroup.valid">
        <ng-template matStepLabel>
          <div fxLayout="row">
            <div fxFlexAlign="center">
              Select Contact
        ...
        <form [formGroup]="thirdFormGroup">
          <div>
            <mat-tab-group [(selectedIndex)]="selectedContactTabIndex">
              <mat-tab label="Customer Contacts">
              ...
              <mat-tab label="Edit Contact" *ngIf="hasEditContactTab">
                <div>
                  ...
                  <div>
                    <button mat-button mat-raised-button color="primary" (click)="updatePendingContact()">Update</button>
                  </div>
...
export class MeetingsCreateStepsComponent implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    ...
    this.forthFormGroup = this._formBuilder.group({
      dateTime: [moment(newMeeting.dateTime).format(dateTimeFormat), Validators.required],
      endDateTime: [moment(newMeeting.endDateTime).format(dateTimeFormat), Validators.required]
    });
