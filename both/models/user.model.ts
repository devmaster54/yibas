...
export class User implements UserModel {
  ...
  // _getManagedUsers$() {
  //   console.log('this.manages users', this.manages);
  //   return MeteorObservable.call('find', 'users', {_id: {$in: this.manages}});
  // }
  ...
  //   };
  //
  //   return MeteorObservable.call('update', 'users', query, update);
  // }
