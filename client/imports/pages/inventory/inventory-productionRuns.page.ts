...
@Component({
  ...
  template: `
    <mat-card *ngIf="view == ''">
      ...
      <div *ngIf="productionOrder">
        <mat-tab-group [selectedIndex]="tabIndex" (selectedIndexChange)="onTabIndexChange($event)" aria-disabled="true">
            ...
            <div  fxLayout="row">
              ...
              <mat-card fxFlex="">
                ...
                <mat-card-content *ngIf="productionOrder">
                  <system-lookup #productionRunWorkersLookup (onComplete)="onWorkersListComplete($event)" isModal="true" [data]="productionRunWorkersLookupData" lookupName="productionRunWorkers" (onSelected)="onClickWorker($event)" (onEvent)="onWorkersListEvent($event)"></system-lookup>
                </mat-card-content>
      ...
      case 'Complete':
        ...
        dialogRef.afterClosed().subscribe((result) => {
          ...
          if (result.value) {
            ...
            this.productionRun._completeRun$(this._systemLogService.systemLog, result.options.enableCompleteOrder)
              // .pipe(
